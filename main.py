...
class ContaMetriApp(App):
    def build(self):
        ...
        # Pulsanti Avvio, Stop, Reset e Tab
    ...
    def start_counting(self, instance):
        ...
        self.update_speed(self.velocita)  # Assicurati che il cursore sia allineato
        if not self.contando:
            self.contando = True
            # Aggiorna ogni 0.1 secondi per una visualizzazione più fluida
